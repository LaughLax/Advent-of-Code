        ...
        for y, line in enumerate(self.input):
            for x, char in enumerate(line):
                if char == '/':
                    if x == 0 or y == 0:
                        # Top left corner
                        grid.add_corner(x, y, 1, 1)
                        
                    elif line[x-1] == '-' or line[x-1] == '+' or line[x-1] == '<' or line[x-1] == '>' or line[x-1] == '\\':
                        # Bottom right corner
                        grid.add_corner(x, y, -1, -1)
...
class Grid:
    ...
    def print(self):
        ...
        for corner in self.corners:
            ...
            if corner_type[0] * corner_type[1] == 1:
    ...
    def add_corner(self, x, y, x_dir, y_dir):
        self.corners[(x, y)] = (x_dir, y_dir)
    ...
    def process_step_pt1(self):
        ...
        for c in carts_ordered:
            ...
            if self.wreck_location:
                break
            
            # Turn if needed
            if (c.x, c.y) in self.corners:
                corner_type = self.corners[(c.x, c.y)]
                corner_type = corner_type[0] * corner_type[1]
                if corner_type == 1:
                    c.direction = {
                        DIR_RIGHT: DIR_UP,
                        DIR_UP: DIR_RIGHT,
...
class Cart:
    ...
    def turn_intersection(self):
        ...
        elif self.next_turn == Cart.TURN_STRAIGHT:
            pass
